...
date: 2025-01-01
weight: 20
book_section: "Безопасность"
---

> **При использовании Claude Code есть две основные опасности:**
>
...
> **Важные правила:**
>
> - Будьте крайне внимательны, если работаете с какими-то чувствительным ресурсами. Даже если это рид-онли запрос в БД статистики - он может положить БД
> - Если вы всё-таки что-то похерили - не скрывайте! Пишите сразу!
> - Уделите внимание дополнительным настройкам безопасности на уровне команды и на личном уровне. Добавьте в deny определённые файлы, разберитесь с настройками MCP. Изучите внимательно всю базу знаний перед тем как приступать к работе
...
Первое, что мы уже сделали — это включили обязательный sandbox на уровне организации. **Важно:** на Windows работает только через WSL2. На ванилле никакого встроенного способа сэндбоксинга сейчас нет, используйте с осторожностью или переходите на поддерживаемую операционную систему. Пример настроек:
...
Это создаёт определённые неудобства — например, нет доступа к GPU и сильные ограничения на сетевые команды.
...
Мы не мега-паникуем по поводу утечки ключей и паролей в Anthropic, тем более что мы в процессе внедрения процесса регулярной ротации паролей и ключей. Тем не менее, базовая гигиена не повредит.

На уровне организации сейчас стоят такие запреты:
...
### Как дать CC доступ к секретам для запуска команд
