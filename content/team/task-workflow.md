...
Рекомендуем не бездумно использовать один и тот же подход для всех задач, а в начале сессии оценивать сложность и выбирать нужный путь:

- Простая задача - пишем промпт в любом формате
- Сложная задача - описываем задачу по принятому командному шаблону
