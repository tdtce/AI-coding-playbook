...
## Улучшаем харнесс по итогам задачи

Самое лучшее, что вы можете сделать по завершении задачи или сессии с агентом - предотвратить повторение ошибок в будущем. Можно попросить этого же или другого агента проверить сессию по чек-листу:

- Агенту не хватило знаний - обновляем или добавляем базу знаний или улучшаем навигацию по ней
- Агент неправильно выполнял часто повторяющееся действие - добавляем скилл или скрипт
- Агент нарушил формализуемое правило - добавляем тест или хук
- Агент совершил нежелательное действие или, наоборот, уткнулся в ограничение - пересматриваем разрешения, сэндбокс и режимы работы
- Агент не смог самостоятельно проверить результат своих действий - даём ему доступ к нужным логам, метрикам и другим сигналам (например, через MCP)
- Агент ходил по кругу - добавляем лимит ходов и явное условие эскалации человеку

Не нужно превращать каждую ошибку в новое правило в `CLAUDE.md`. Проверьте, есть ли более надёжные способы избавиться от такой же ошибки.
