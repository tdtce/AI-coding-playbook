...
Результаты обсуждений зафиксировать в документе с обязательными и рекомендуемыми практиками - командый playbook. На первое время пока практики не устоятся важно иметь один источник правды.
