...
В современной разработке появился новый потребитель документации - это ИИ-агенты. Ранее главной входной точкой в репозитории являлся файл README.md, который служит общим описанием того, зачем репозиторий нужен и как им пользоваться. Многие важные для ИИ-агента вещи в репозитории часто отсутствуют, потому что либо лежат где-то в другом месте, либо в головах у людей:

- политики по написанию кода 
- разрешенные инструменты и библиотеки
- бизнес-смысл и архитектура проекта
- контекст по работе продукта и ранее принятые решения
...
> **Внимание:** НЕ рекомендуем использовать `/init` для создания CLAUDE.md. По большей части он напихает бесполезного содержимого. Можно запустить в начале, посмотреть, что он сгенерит и выкинуть всё лишнее или перенести в другие файлы документации.
>
