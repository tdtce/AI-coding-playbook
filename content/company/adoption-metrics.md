...
### Метрики агентского процесса

Кроме статистики использования ИИ-инструментов сотрудниками и финальных бизнес-метрик полезно ещё измерять сам агентский процесс:

| Вопрос | Возможная метрика |
|---|---|
| Агент действительно решил задачу? | Доля задач, прошедших acceptance criteria и обязательные проверки |
| Сколько внимания потребовалось? | Количество вмешательств и время ручных исправлений на задачу |
| Насколько результат стабилен? | Откаты и хот-фиксы после релизов |
| Сработала ли обратная связь? | Доля замечаний, найденных тестами, линтерами и AI-ревью до человеческого ревью |
| Сколько стоил полезный результат? | Токены, деньги и человеческое время на успешно завершённую задачу |
| Насколько хорошо агент исправляется? | Доля сбоев, которые агент самостоятельно устранил после получения обратной связи |

Необязательно собирать всё сразу — выбирайте метрики под текущий процесс и доступные источники.

Автономность, количество созданных PR и строк кода сами по себе не являются целевыми метриками, их нужно рассматривать совместно с ростом дефектов и затраченным человеческим временем.
